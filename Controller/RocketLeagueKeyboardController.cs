...
{
    public class RocketLeagueKeyboardController : IRocketLeagueController
    {
        ...
        public RocketLeagueKeyboardController()
        {
        ...
        private void BoostWorker(object sender, DoWorkEventArgs args)
        {
            ...
            while(this.BoostEngaged && this.IsGameWindowFocused())
            {
