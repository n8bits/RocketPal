...
namespace RocketPal.Models.GameObjects
{
    public class GameInstance
    {
        ...
        private RocketLeagueController menuController;
            ...
            if (this.Clock != null)
            {
                ...
                if (Clock.TimeRemaining < 1)
                {
                    ...
                    else
                    {
                        ...
                        this.menuController.StartNewGame();
                        this.LogMessage("Attempt complete. Matchmaking should be underway now.");
                        this.gameOver = true;
                        this.Clock = null;
                        return;
                    }
        ...
        public void SkipReplayTask(Object sender, DoWorkEventArgs args)
        {
            ...
            {
                Thread.Sleep(1000);
                this.menuController.SkipReplay();
            }
